class QLabelBehavior extends Behavior {
	static __autoRegister = Behavior._register(this);
}
class QLabelBehaviorAddAanimationEffect extends QLabelBehavior {
	// 日期选择器
	static async initDatePicker() {
...
// 辅助函数
class QLabelBehaviorHelperUtils extends QLabelBehavior {
...
class QLabelBehaviorUpdateUIElement extends QLabelBehavior {
	constructor() {
		super();
	}
	static async workHour() {
